...
class UpdateScriptVersionController extends Controller
{
    ...
    {
        return config('global.allow_users_id');
    }
    ...
    */
    public function update()
    {
        ...
        try {
            ...
            $filename_tmp = config('global.tmp_path') . '/' . $update_name;
    ...
    public function install()
    {
        ...
        $update_path = config('global.tmp_path') . '/' . $archive;
    ...
    */
    public function download(Request $request)
    {
        ...
        $downloadRemoteUrl = config('global.update_baseurl') . '/' . $update_name;
    ...
    */
    ...
    public function updateDatabase()
    {
        ...
        return 'Database updated successfully. <a href="' . route(config('global.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    public function clearCache()
    {
        ...
        return 'Cache cleared successfully. <a href="' . route(config('global.redirectRoute')) . '">Click here to Login</a>';
    }
    ...
    public function refreshCache()
    {
        ...
        return 'Cache refreshed successfully. <a href="' . route(config('global.redirectRoute')) . '">Click here to Login</a>';
    }
}
