...
@if(!is_null($sourceUpdateCompanySetting->supported_until))
    <div class="col-md-12" id="support-div">
        @if(\Carbon\Carbon::parse($sourceUpdateCompanySetting->supported_until)->isPast())
            <div class="col-md-12 alert alert-danger ">
                <div class="col-md-6">
                    Your support has been expired on <b><span
                                id="support-date">{{\Carbon\Carbon::parse($sourceUpdateCompanySetting->supported_until)->format('d M, Y')}}</span></b>
                </div>
                <div class="col-md-6 text-right">
                    <a href="{{ config('global.product_url') }}" target="_blank"
